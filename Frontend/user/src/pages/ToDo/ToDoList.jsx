...
function ToDoList() {
  ...
  const [ incompletedTodo, setInompletedTodo ] = useState([]);
  ...
  const handleSearch = (e) => {
    ...
    let filteredList = allToDo.filter((item) => item.title.toUpperCase().match(query.toUpperCase()));
